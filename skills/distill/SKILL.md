...
3. **Writes the distillation** to a timestamped file:
   ```
   .pi/distillations/YYYY-MM-DD-HHMMSS-<slug>.md
   ```

4. **Outputs a handoff directive** the user can copy into a fresh session:
   ```
   Continue from distillation: .pi/distillations/<filename>.md
   ```
...
```
Distillation saved to: .pi/distillations/2026-02-01-143022-offline-driver.md

To continue in a fresh session, copy this prompt:

---
Continue from distillation: .pi/distillations/2026-02-01-143022-offline-driver.md
