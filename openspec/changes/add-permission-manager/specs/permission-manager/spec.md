> **OpenSpec change:** `add-permission-manager`  
> **Primary implementation:** `extensions/permission-manager/`; **integration:** `extensions/security-engine/index.ts`, `package.json` `pi.extensions`, optional **`extensions/dashboard`** footer wiring.
...
*(none — delta spec for a new capability.)*

## MODIFIED Requirements

*(none — no baseline `openspec/specs/permission-manager/` in this repo yet.)*
