...
> **Implementation:** first-party Ollama extension under **`extensions/`**. **[@0xkobold/pi-ollama](https://www.npmjs.com/package/@0xkobold/pi-ollama)** is a **behavioral reference**, not a mandatory npm dependency.
