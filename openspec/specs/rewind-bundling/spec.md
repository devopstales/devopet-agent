# Rewind bundling (first-party)

## Purpose

Turn-based git checkpoints, **`/rewind`**, diff preview, redo, and safe restore via first-party **`extensions/`**. **[pi-rewind](https://github.com/arpagon/pi-rewind)** is a **behavioral reference**, not a mandatory npm dependency.
