...
**DESIGN.md** as the canonical plain-text UI design contract at the project root, aligned with [Google Stitch DESIGN.md](https://stitch.withgoogle.com/docs/design-md/overview).
