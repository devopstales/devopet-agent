...
Teams defined in YAML with dispatch-only primary orchestration. **[agent-pi](https://github.com/ruizrica/agent-pi) agent-team** is a **behavioral reference**, not a mandatory dependency.
