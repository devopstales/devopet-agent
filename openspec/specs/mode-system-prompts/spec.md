...
Per-mode system prompts (or equivalent) align agent behavior with **NORMAL** through **CHAIN**. **[agent-pi](https://github.com/ruizrica/agent-pi)** prompt patterns **may align** as a **reference**.
