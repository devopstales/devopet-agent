# Checkpoint footer and dashboard

## Purpose

Integrates rewind checkpoint status into the **dashboard** footer as a **single** `setFooter` surface—no competing footer factories.
