...
Background subagent visibility and non-blocking orchestration in the TUI. **[agent-pi](https://github.com/ruizrica/agent-pi) subagent-widget** is a **behavioral reference**, not a mandatory dependency.
