# Pipeline team (hybrid)

## Purpose

Five-phase pipelines with sequential and parallel segments. **[agent-pi](https://github.com/ruizrica/agent-pi) pipeline-team** is a **behavioral reference**, not a mandatory dependency.
