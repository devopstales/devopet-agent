...
Optional file-backed swarm messaging and **`/messenger`** when enabled. **[pi-messenger-swarm](https://www.npmjs.com/package/pi-messenger-swarm)** is a **behavioral reference**, not a mandatory npm dependency.
