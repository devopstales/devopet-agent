# Memory embedding without Ollama

## Purpose

Semantic memory SHALL not assume a local Ollama embedding backend; cloud/custom embeddings and graceful keyword fallback are first-class.
