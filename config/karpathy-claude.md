<!--
  Kept in sync with config/SYSTEM.md § Behavioral guidelines (Karpathy-inspired).
  Source: https://raw.githubusercontent.com/forrestchang/andrej-karpathy-skills/refs/heads/main/CLAUDE.md
  Override: <project>/.devopet/karpathy-claude.md or ~/.devopet/karpathy-claude.md
-->
