...
The dashboard extension replaces pi's default footer with a multi-mode persistent display that unifies state from across all omegon-pi subsystems. It provides four display modes:
